...
public class Allergene {
    ...
    public Allergene(String nom, double qteMilligrammes) {
        if (nom == null || nom.isBlank()) {
            throw new IllegalArgumentException("Le nom de l'allergène ne peut pas être null ou vide");
        }
    ...
    public String toString() {
        return "Allergene{nom='" + nom + "', qteMilligrammes=" + qteMilligrammes + "}";
    }
}
